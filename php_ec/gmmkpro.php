...
<html lang="ja">
    <head>
        ...
        <link rel="stylesheet" href="css/gmmkpro.css">
    ...
    <article>
        <div class="side">
            ...
            <div class="text2">
                <p2>
                GMMK PRO is an ultra premium, <br>
                gasket-mounted 75% layout keyboard built for enthusiasts, <br>gamers, and professionals.<br>
                </p2>
            </div>
            <p3>23,000円</p3>
            <br>
            ...
            <form action="cart-insert.php" method="post">
                <input type="hidden" name="name" value="GMMKpro">
    ...
    <div class="content">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/Gmmk2pro.jpg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/gmmk2pro2.jpg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/gmmk2pro3.jpg" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/gmmk2pro4.jpg" alt="Fourth slide">
            </div>
        </div>
